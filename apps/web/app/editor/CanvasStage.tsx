...
import { renderToolPreview as renderToolPreviewUtil } from "./canvas/toolPreview.ts";
import {
  ...
  hitTestPathSegment,
} from "./canvas/hitTest.ts";
import { buildSeatsByRow, makeRowCentroidGetter } from "./canvas/seatIndex.ts";
import { useSeatTypes } from "./hooks/useSeatTypes.ts";
import { useMouseDown } from "./hooks/useMouseDown.ts";

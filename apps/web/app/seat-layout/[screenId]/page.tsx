...
import {
  ...
  TextElement,
  ImageElement,
} from "../components/svg-elements/index.ts";
import { SeatCanvas } from "../components/SeatCanvas.tsx";
import { buildSeatSpatialIndex } from "../utils/spatialIndex.ts";
import { useSeatLayout } from "../hooks/useSeatLayout.ts";
import { useSeatSelection } from "../hooks/useSeatSelection.ts";
import { useViewportControls } from "../hooks/useViewportControls.ts";
import { useStandingSection } from "../hooks/useStandingSection.ts";
import { useSeatColors } from "../hooks/useSeatColors.ts";
